    ...
    return (
        <>
            <div className='w-10/12 flex flex-col justify-between mx-auto mt-10'>
                ...
                <div className="items-center bg-[#fff] flex border-[1px] border-solid border-[#FDD563] rounded-[12px] text-[#585A66] text-[14px] font-[400] mb-5 mt-5">
                    <span><img src={yearone} className="pt-[10px]" /></span>
                    <span className=" text-[#585A66] text-[20px] font-[700]">Year 7-9</span>
                </div>
                <div className="items-center bg-[#fff] flex border-[1px] border-solid border-[#8BE38B] rounded-[12px] text-[#585A66] text-[14px] font-[400] mb-5">
                    <span><img src={yeartwo} className="pt-[10px]" /></span>
                    <span className=" text-[#585A66] text-[20px] font-[700]">Year 10-11</span>
                </div>
                <div className="items-center bg-[#fff] flex border-[1px] border-solid border-[#B3B4F7] rounded-[12px] text-[#585A66] text-[14px] font-[400] mb-5">
                    <span><img src={yearthree} className="pt-[10px]" /></span>
                    <span className=" text-[#585A66] text-[20px] font-[700]">Year 12-13</span>
                </div>
                <div className="items-center bg-[#fff] flex border-[1px] border-solid border-[#C4D7FF] rounded-[12px] text-[#585A66] text-[14px] font-[400] mb-5">
                    <span><img src={bachelors} className="pt-[10px]" /></span>
                </div>
                <div className="items-center bg-[#fff] flex border-[1px] border-solid border-[#E48FFF] rounded-[12px] text-[#585A66] text-[14px] font-[400] mb-5">
